% function [ACC,MIhat,Purity,P,R,F,RI] = ClusteringMeasure1(Y, predY)
function result = ClusteringMeasure_onlyANA(Y, predY)

% clustering measurement only for Acc, Nmi and Ari
